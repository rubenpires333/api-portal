...
INSERT INTO notification_templates (id, type, channel, language, subject, template, variables, created_at, updated_at) VALUES
(gen_random_uuid(), 'SUBSCRIPTION_REQUESTED', 'IN_APP', 'pt', 
...
(gen_random_uuid(), 'SUBSCRIPTION_APPROVED', 'IN_APP', 'pt',
...
(gen_random_uuid(), 'RATE_LIMIT_EXCEEDED', 'IN_APP', 'pt',
 'Limite Excedido',
...
INSERT INTO notification_templates (id, type, channel, language, subject, template, variables, created_at, updated_at) VALUES
(gen_random_uuid(), 'SUBSCRIPTION_REQUESTED', 'EMAIL', 'pt',
...
(gen_random_uuid(), 'SUBSCRIPTION_APPROVED', 'EMAIL', 'pt',
...
(gen_random_uuid(), 'SUBSCRIPTION_REVOKED', 'EMAIL', 'pt',
...
(gen_random_uuid(), 'API_VERSION_RELEASED', 'EMAIL', 'pt',
